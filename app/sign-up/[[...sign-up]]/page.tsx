...
export default function SignUpPage() {
  return (
    <main className="min-h-screen bg-linear-to-br from-pink-50 via-white to-pink-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <p className="text-center text-gray-600 mt-6">
          ...
          <Link href="/sign-in" className="text-pink-600 hover:text-pink-700 font-semibold hover:underline">
            লগইন করুন
          </Link>
        </p>
      </div>
